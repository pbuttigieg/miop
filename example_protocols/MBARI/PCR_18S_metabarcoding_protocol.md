...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| Durable equipment |
| ultraviolet light source [OBI:0002900] | Content Cell | Content Cell | Content Cell | Content Cell |
| PCR instrument [OBI:0000989] | Content Cell | Content Cell | Content Cell | Content Cell |
| electrophoresis system [OBI:0001053] | Content Cell | Content Cell | Content Cell | Content Cell |
| fluorometer [OBI:0400143] | FMAX Fluorometer | Molecular Devices | Content Cell | with SoftMaxPro v1.3.1 |
| Consumable equipment |
| Agarose gel | Content Cell | Content Cell | 2 | Content Cell |
| Agencourt AMPure XP bead system | Beckman Coulter, USA | Content Cell | Content Cell | Content Cell |
| Quant-It Picogreen dsDNA Assay (Life Technologies) | Content Cell | Content Cell | Content Cell | Content Cell |
| Chemicals |
| 10% Bleach | Content Cell | Content Cell | Content Cell | Content Cell |
| 70% Ethanol | Content Cell | Content Cell | Content Cell | Content Cell |
| RNase Away | Content Cell | Content Cell | Content Cell | Content Cell |
| Amplitaq Gold Fast PCR mastermix | Content Cell | Content Cell | Content Cell | Content Cell |
| molecular-biology grade water | Content Cell | Content Cell | Content Cell | Content Cell |
| forward and reverse primers (5 μM) | Content Cell | Content Cell | Content Cell | Content Cell |
